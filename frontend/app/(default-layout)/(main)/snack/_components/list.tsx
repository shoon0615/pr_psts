...
const MOCK_SNACKS = [
  ...
  {
    id: 2,
    title: 'Connect with your desktop',
    description: 'Use the desktop application to manage your assets securely.',
    buttonText: 'Details'
  },
  {
    id: 3,
    ...
    description:
      'Initialize your hardware wallet and secure your recovery phrase.',
    buttonText: 'Setup'
  },
  {
    id: 4,
    title: 'Mobile App Syncing',
    description:
      'Keep your mobile and desktop apps in sync for real-time tracking.',
    buttonText: 'Sync Now'
  },
  {
    id: 5,
      ...
      {MOCK_SNACKS.map(snack => (
        <div
          ...
          <div className="max-h-0 overflow-hidden opacity-0 transition-all duration-300 ease-in-out group-hover:max-h-32 group-hover:opacity-100">
            <div className="rounded-b-xl border border-t-0 border-gray-200 bg-white p-4 shadow-lg">
              <Button
                variant="secondary"
                className="w-full bg-gray-100 font-semibold text-gray-900 hover:bg-gray-200">
                {snack.buttonText}
              </Button>
            </div>
          </div>
